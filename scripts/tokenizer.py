...
NLTK_WORD_LANGS = ["ace", "ar", "ayr", "az", "ban", "be", "bem", "bjn", "bm", "bug", "ceb", "crh", "dik","dyu", "dz", "fa", "fj", "fo", "fon", "fur", "fuv",
...
INDIC_LANGS = ["awa", "gu" ,"hi", "hne", "kn", "ks", "mag", "mai", "mr", "ne", "pa", "sa", "sat", "te", "ur"]
