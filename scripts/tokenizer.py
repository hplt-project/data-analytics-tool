...
NLTK_WORD_LANGS = ["ar", "as", "ayr", "az", "ban", "be", "bm", "bem", "ceb", "dik","dyu", "dz", "fa", "fuv", "ht", "hy", "jv",
                    "ka", "kab", "kac","kbp", "kea", "kg", "kk", "kmb", "ky", "li", "lmo",  "ltg", "lus", "min", "mn", "mni",
                    "ms", "nso", "oc", "pag", "plt", "ps","rn", "rw","sm", "tk","tn", "tt", "tw", "tzm",
                    "uk", "ug", "umb", "vec", "vi", "xh", "zu"]
