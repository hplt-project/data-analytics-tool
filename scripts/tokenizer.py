...
NLTK_WORD_LANGS = ["ace", "ar", "ayr", "az", "ban", "be", "bjn", "bm", "bem", "ceb", "crh", "dik","dyu", "dz", "fa", "fo", "fon", "fuv", "gaz", "gd", "ha", "ht", "hy","ilo", "jv",
...
INDIC_LANGS = ["awa", "gu" ,"hi", "hne", "kn", "mag", "mai", "mr", "ne", "pa", "sa", "sat", "te", "ur"]
